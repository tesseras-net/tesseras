+++
title = "Sobre"
description = "Tesseras é uma rede peer-to-peer para preservar memórias humanas através dos milênios — porque sua história merece sobreviver a qualquer plataforma."
+++
...
- **Google Fotos, iCloud, OneDrive** — suas memórias vivem no servidor de outra pessoa, sob os termos de serviço de outra pessoa, atrás do paywall de outra pessoa
- **Redes sociais** — a história da sua vida está espalhada por plataformas que tratam suas memórias como inventário de publicidade
- **HDs e pendrives** — falham silenciosamente, sem aviso e sem backup
- **DVDs e CDs** — já são ilegíveis para a maioria das pessoas
...
- **Formatos de mídia mais simples** — JPEG para fotos, WAV para áudio, WebM para vídeo, texto simples para escrita. Não porque são os melhores, mas porque serão legíveis por mais tempo.
- **Sem criptografia por padrão** — disponibilidade acima do sigilo. Uma memória que não pode ser descriptografada é uma memória perdida. Memórias privadas podem ser criptografadas, mas o padrão é a sobrevivência.
- **Sem dependência da internet** — tesseras podem ser armazenadas em pendrives, mídias ópticas, Raspberry Pis em uma prateleira, até dispositivos IoT de baixo consumo. Qualquer cópia é uma cópia válida.
