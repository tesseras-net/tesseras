...
A melhor forma de contatar o projeto é através das [listas de discussão](/pt-br/subscriptions/):

- [tesseras-discuss](https://lists.sr.ht/~ijanc/tesseras-discuss) — perguntas, suporte, discussão geral
- [tesseras-devel](https://lists.sr.ht/~ijanc/tesseras-devel) — patches e desenvolvimento
