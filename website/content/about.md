+++
title = "About"
description = "Tesseras is a peer-to-peer network for preserving human memories across millennia — because your story deserves to outlive every platform."
+++
...
- **Google Photos, iCloud, OneDrive** — your memories live on someone else's server, under someone else's terms of service, behind someone else's paywall
- **Social media** — your life story is scattered across platforms that treat your memories as advertising inventory
- **Hard drives and USB sticks** — they fail silently, with no warning and no backup
- **DVDs and CDs** — already unreadable for most people
...
- **Simplest media formats** — JPEG for photos, WAV for audio, WebM for video, plain text for writing. Not because they're the best, but because they'll be readable the longest.
- **No encryption by default** — availability over secrecy. A memory that can't be decrypted is a memory that's lost. Private memories can be encrypted, but the default is survival.
- **No dependency on the internet** — tesseras can be stored on USB drives, optical media, Raspberry Pis on a shelf, even low-power IoT devices. Any copy is a valid copy.
